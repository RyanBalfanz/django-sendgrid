...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Event', fields ['creation_time', 'event_type']
        db.create_unique('sendgrid_event', ['creation_time', 'event_type_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Event', fields ['creation_time', 'event_type']
        db.delete_unique('sendgrid_event', ['creation_time', 'event_type_id'])
    ...
    models = {
        ...
        'sendgrid.event': {
            'Meta': {'unique_together': "(('creation_time', 'event_type'),)", 'object_name': 'Event'},
