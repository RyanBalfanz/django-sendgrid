...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sendgrid_event', 'creation_time', self.gf('django.db.models.fields.DateTimeField')(unique=True))
        # Adding unique constraint on 'Event', fields ['creation_time']
        db.create_unique('sendgrid_event', ['creation_time'])


    def backwards(self, orm):
        # Removing unique constraint on 'Event', fields ['creation_time']
        db.delete_unique('sendgrid_event', ['creation_time'])
    ...
    models = {
        ...
        'sendgrid.event': {
            ...
            'creation_time': ('django.db.models.fields.DateTimeField', [], {'unique': 'True'}),
